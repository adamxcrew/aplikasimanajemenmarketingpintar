...
<div class="container-fluid">
    ...
    <form action="<?= base_url('admin/detail_pendapatan/').$this->uri->segment('3') ?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pendapatan as $pend) : ?>
                                        <tr>
                                            ...
                                            <td><?= number_format($pend['pendapatan_termin1']) ?></td>
                                            <td><?= number_format($pend['pendapatan_termin2']) ?></td>
                                            <td><?= number_format($pend['pendapatan_termin3']) ?></td>
