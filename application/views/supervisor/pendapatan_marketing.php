...
<div class="container-fluid">
    ...
    <p>Filter :</p>
    <form action="<?= base_url('supervisor/pendapatan_marketing') ?>" method="post">
                            ...
                            <table class="table table-hover" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Total Pendapatan Marketing</th>
                                        <th>Opsi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <?php if (!empty($pendapatan)) : ?>
                                        ...
                                        foreach ($pendapatan as $pend) : ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url('supervisor/detail_pendapatan/').$pend['id_marketer'] ?>" class="btn btn-info btn-sm">Detail</a></td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
                                    <?php else : ?>
