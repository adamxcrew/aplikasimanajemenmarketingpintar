                                    ...
                                    <?php if (!empty($termin)) : ?>
                                        <?php foreach ($termin as $term) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('supervisor/markdone?id=') . $term['id_termin'] ?>" class=" badge badge-success" onclick="return confirm('Yakin ingin mengubah termin menjadi selesai?')">Selesai</a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
